...
const MobileUserPage = () => {
  ...
  return (
    <Box scrollSnapAlign="start" w={'100%'} padding={'12px'}>
      <Card bgColor={'#3646B3'} height={'276px'} width={'100%'} borderRadius={'10px'} position={'relative'} as={VStack} cursor={'pointer'} mt={'120px'}>
      ...
      <VStack colSpan={1} bgColor={'#F7F7F7'} padding={'16px'} borderRadius={'15px'} mt={'10px'}>
        <HStack w={'100%'} justifyContent={'space-between'}>
